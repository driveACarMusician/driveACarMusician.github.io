...
class Level1 extends Phaser.Scene {
  ...
  preload() {
    this.load.image('coin', 'assets/png/dollar.png');
    this.load.image('cone', 'assets/png/traffic-cone.png');
    this.load.image('roadblock', 'assets/png/roadblock.png');
    this.load.image('road', 'assets/png/roadloop.png');
    this.load.image('top', 'assets/png/invis.png');
    this.load.image('finish', 'assets/png/finish.png');
    this.load.image('rock', 'assets/png/rock.png');
    this.load.spritesheet('carSpriteYellow', 'assets/png/CarSpriteYellow.png', { frameWidth: 240, frameHeight: 225 });
    this.load.spritesheet('carSpriteRed', 'assets/png/CarSpriteRed.png', { frameWidth: 240, frameHeight: 225 });
    this.load.spritesheet('carSpriteBlue', 'assets/png/CarSpriteBlue.png', { frameWidth: 240, frameHeight: 225 });
    this.load.spritesheet('carSpriteOrange', 'assets/png/CarSpriteOrange.png', { frameWidth: 240, frameHeight: 225 });
    this.load.spritesheet('carSpritePurple', 'assets/png/CarSpritePurple.png', { frameWidth: 240, frameHeight: 225 });
    this.load.spritesheet('carSpriteGreen', 'assets/png/CarSpriteGreen.png', { frameWidth: 240, frameHeight: 225 });
    this.load.audio('song1', 'assets/mp3/music.mp3');
  }
  ...
  create() {
    ...
    //check game config for car color
    ...
    for (var i = 0; i <= gameObjects; i++) {
      ...
      if (i < gameObjects) {
        // console.log(i, gameObjects, randomValue);
        if (randomValue <= 0.3) {
          //make coin
  ...
  update() {
    //make coins obstacles and finish line move at the same speed as the background
